...
<div class="jumbotron">
    ...
    <h1>Repair details  ${repair.repairDesc} </h1>
    ...
    <form method="POST">
        ...
        <input type="hidden" id="carPartId" name="carPartId" value="${carPart.carPartId}">
        <input type="submit" value="Delete"  class="btn btn-default" formaction="/PartDeleteFromRepairPost" />
    </form>
